 ...
 */
class CommodityLinearItemViewBinder : ItemViewBinder<Commodity, CommodityLinearItemViewBinder.CommodityGridViewHolder>() {
    override fun onCreateViewHolder(inflater: LayoutInflater, parent: ViewGroup): CommodityGridViewHolder
            = CommodityGridViewHolder(inflater.inflate(R.layout.item_main_shop_main_commodity_linear, parent, false))
