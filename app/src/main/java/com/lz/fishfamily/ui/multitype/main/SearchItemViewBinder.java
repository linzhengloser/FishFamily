 ...
 * </pre>
 */
public class SearchItemViewBinder extends ItemViewBinder<String, SearchItemViewBinder.SearchViewHolder> {


    @NonNull
    @Override
    protected SearchViewHolder onCreateViewHolder(@NonNull LayoutInflater inflater, @NonNull ViewGroup parent) {
        return new SearchViewHolder(inflater.inflate(R.layout.item_main_search, parent, false));
    }
