package com.lz.library.ui.view.itemdecoration;
...
import com.lz.library.ui.view.indexbar.BaseIndexTagBean;
 ...
 *     time   : 2017/08/26
 *     desc   : 使用ItemDecoration 实现类似 微信联系人列表
 *     version: 1.0
 * </pre>
 */
public class TitleItemDecoration extends RecyclerView.ItemDecoration {
     ...
     * 标题字体颜色
     */
    private static int COLOR_TITLE_FONT = Color.parseColor("#242424");
    /**
     * 标题字体颜色
     */
    ...
    public TitleItemDecoration(Context context, List<? extends BaseIndexTagBean> cityList) {
        ...
        mPaint = new Paint();
        mFontRect = new Rect();
        mTitleHeight = AutoUtils.getPercentHeightSize(50);
        mTitleFontSize = AutoUtils.getPercentHeightSize(30);
